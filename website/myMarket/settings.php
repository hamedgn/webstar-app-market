            ...
            <div class="col s12 m12 l12">
                ...
                <div class="row msg-form">
                    ...
                    <form class="" action="/settings.php" method="POST">
                        ...
                        <div class="input-field col s12">
                            <input type="text" class="validate" id="phone" name="phone" value="<?php echo $accountInfo['phone']; ?>" style="direction:ltr;">
                        ...
                        <div class="input-field col s12">
                            <input type="text" class="validate" id="facebook_page" name="facebook_page" value="<?php echo $accountInfo['fb_page']; ?>" style="direction: ltr;">
                            <label for="facebook_page" class="active"><?php echo $LANG['label-facebook-link']; ?></label>
                        </div>

                        <div class="input-field col s12">
                            <input type="text" class="validate" id="instagram_page" name="instagram_page" value="<?php echo $accountInfo['instagram_page']; ?>" style="direction: ltr;">
