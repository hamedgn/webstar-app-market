        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                <div class="row more_cont">
                    <div class="col s12">
                        <a href="javascript:void(0)" onclick="Favorites.moreItems('<?php echo $result['itemId']; ?>'); return false;">
...
<main class="content">
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 left favorites_cont">

                <h2 class="header"><?php echo $LANG['page-favorites']; ?></h2>
        ...
        <script type="text/javascript">
            ...
            Favorites.moreItems = function (offset) {
