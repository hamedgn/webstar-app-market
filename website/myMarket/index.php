...
<div class="section no-pad-bot" id="index-banner">
    ...
    <div class="container" style="margin-top: 140px; margin-bottom: 140px;">
        ...
        <div class="row center">
            <h5 class="header col s12 light">همین حالا <?php echo APP_NAME; ?> را دریافت کنید !</h5>
        </div>

        <div class="row center">
            <a href="<?php echo GOOGLE_PLAY_LINK; ?>">
                <button class="btn-large waves-effect waves-light teal">دانلود <?php echo APP_NAME; ?> از کافه بازار<i class="material-icons left">file_download</i></button>
            </a>
        </div>
