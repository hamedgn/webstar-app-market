                                        ...
                                        <table class="bordered data-tables responsive-table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th class="text-left">از اکانت</th>
                                                    <th class="text-left">ایمیل</th>
                                                    <th class="text-left">موضوع</th>
                                                    <th class="text-left">توضیحات</th>
                                                    <th class="text-left">تاریخ ارسال</th>
                                                    <th>عملیات</th>
                                                </tr>
...
<?php
    ...
    function draw($dbo, $value)
    {
        ...
        <tr>
            ...
            <td><a href="/admin/support.php/?ticketId=<?php echo $value['id']; ?>&act=delete&access_token=<?php echo admin::getAccessToken(); ?>">حذف</a></td>
        </tr>
