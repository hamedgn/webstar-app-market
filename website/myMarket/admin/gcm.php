            ...
            <div class="card">
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col s11">
                                <h4>ارسال نوتیفیکیشن برای تمامی کاربران</h4>
                            </div>
                        </div>
                                        ...
                                        <div class="col s12">
                                            <div class="card blue-grey lighten-2">
                                                <div class="card-content white-text">
                                                    <span class="card-title">ارسال نوتیفیکیشن در حالت آزمایشی غیر فعال است</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form method="post" action="/admin/gcm.php">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <select name="type">
                                        <option selected="selected" selected value="<?php echo GCM_NOTIFY_SYSTEM; ?>">برای تمام کاربران</option>
                                           <option value="<?php echo GCM_NOTIFY_CUSTOM; ?>">فقط برای کاربران تایید شده</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <h4>پیام هایی که به تازگی ارسال شده است</h4>
                            </div>
                        </div>
...
<?php
    ...
    function draw($authObj)
    {
        ...
        <tr>
            ...
            <td><?php if ($authObj['status'] == 1) {echo "موفق";} else {echo "ناموفق";} ?></td>
