        ...
        if ($accessToken === admin::getAccessToken() && !APP_DEMO) {
            ...
            switch($act) {
                ...
                case "delete": {
                    ...
                    $reports->removeAllItemsReports();
                    unset($reports);

                    header("Location: /admin/item_reports.php");
                    exit;
            ...
            <div class="card">
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <h4>Item Reports (Latest reports)</h4>
                            </div>
                        </div>
                        ...
                        <div class="col s12">
                            ...
                            <?php
                                ...
                                $result = $reports->getItemsReports(50);
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <a href="/admin/item_reports.php/?act=delete&access_token=<?php echo admin::getAccessToken(); ?>">
...
<?php
    ...
    function draw($item)
    {
        ...
        <tr>
            ...
            <td><?php if ($item['abuseFromUserId'] == 0) {echo "-";} else {echo "<a href=\"/admin/profile.php/?id={$item['abuseFromUserId']}\">From profile Id ({$item['abuseFromUserId']})</a>";} ?></td>
            <td><?php echo "<a href=\"/admin/item_view.php/?id={$item['abuseToItemId']}\">To Item Id ({$item['abuseToItemId']})</a>"; ?></td>
            <td>
                <?php
