                            ...
                            if (isset($_GET['result'])) {
                                ...
                                switch ($result) {
                                    ...
                                    case "success": {
                                        ...
                                        <div class="card teal">
                                            <div class="card-content white-text">
                                                <span class="card-title">مچکریم !</span>
                                                <p>رمزعبور جدید ذخیره شد</p>
                                            </div>
                                        </div>
                                    ...
                                    case "error": {
                                        ...
                                        <div class="card red">
                                            <div class="card-content white-text">
                                                <span class="card-title">اوپس!</span>
                                                <p>رمز قبلی اشتباه است یا اینکه فرمت رمز جدید نادرست است</p>
                                            </div>
                                        </div>
                            ...
                            <form method="post" action="/admin/settings.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <label for="current_passw">رمز فعلی</label>
                                    </div>

                                    <div class="input-field col s12">
                                        <input type="password" class="validate" name="new_passw" id="new_passw">
                                        <label for="new_passw">رمز جدید</label>
                                    </div>
