                    ...
                    <a href="/view_item.php/?id=<?php echo $item['id']; ?>">
                        <div class="card">
                            <div class="card-image">
                                ...
                                <span class="card-title" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center;"><?php echo $item['price']; ?><?php echo $LANG['label-currency']; ?></span>
                            </div>
