                                ...
                                <li class="collection-item avatar" style="padding-left: 94px">
                                    ...
                                    <p>
                                        ...
                                        <?php
                                            ...
                                            if ($profileInfo['online']) {
                                                ...
                                                echo "<span class=\"teal-text\">آنلاین</span>";
                                                ...
                                                if ($profileInfo['lastAuthorize'] == 0) {
                                                    ...
                                                    echo " آخرین بازدید : " . $profileInfo['lastAuthorizeTimeAgo'];
                                                }
                                            }
                                        ?>
                                    ...
                                    <?php
                                        ...
                                        if ($profileInfo['id'] == auth::getCurrentUserId()) {
                                            ...
                                            ?>
                                                <a href="/settings.php" class="secondary-content <?php echo SITE_TEXT_COLOR; ?>" style="margin-right:180px;"><i class="material-icons">mode edit</i></a>
                                            <?php
                                        }
