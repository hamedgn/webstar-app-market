        ...
        if (!$error) {
            ...
            if ($accountId != 0) {
                ...
                if ($accountInfo['error'] === false && $accountInfo['state'] != ACCOUNT_STATE_BLOCKED) {
                    ...
                    <html>
                    <body>
                    این لینک <a href="<?php echo APP_URL;  ?>/restore/?hash=<?php echo $restorePointInfo['hash']; ?>"><?php echo APP_URL;  ?>/restore/?hash=<?php echo $restorePointInfo['hash']; ?></a> رمز عبور جدید می باشد
                    </body>
                    </html>
                    ...
                    $subject = APP_TITLE." | بازیابی رمزعبور";
