package ir.ldev.setareshahr.constants;
...
public interface Constants {
    ...
    public static final String SENDER_ID = "334510540126";  //GOOGLE API Sender ID

    public static final String WEB_SITE = "http://tablighchi.webstarshz.ir/";  //web site url address

    public static final String CLIENT_ID = "1";  //Client ID | For identify the application | Example: 12567

    public static final String API_DOMAIN = "http://tablighchi.webstarshz.ir/";  //url address to which the application sends requests
